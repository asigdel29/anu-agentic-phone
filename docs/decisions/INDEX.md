...
| [inference-needs-a-phone.md](inference-needs-a-phone.md) | Why is the local tier unmeasured, why was it built around rather than waited on, and what would running a model on the phone actually take? |
...
| [an-agentic-android.md](an-agentic-android.md) | What would a phone this agent was privileged on change, and which constraints would survive it anyway? |
